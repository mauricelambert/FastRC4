...
; encrypt([IN] char *key, [IN/OUT] char *data) -> NULL
; decrypt([IN] char *key, [IN] char iv[256], [IN/OUT] char *data) -> NULL

global arc4, generate_iv, generate_key, xor_key_iv, reset_key, get_iv, set_iv, encrypt, decrypt
